...
def send_email(name, email, message):
    ...
    receiver_email = "contact.a3isp@gmail.com"  # Replace with the email that receives messages
...
def main():
    ...
    st.markdown(
        "Please answer our survey [Link to our Survey](https://docs.google.com/forms/d/e/1FAIpQLSduSvvWUvwmEeH1ckVlPGgcIL8sTDTDqRMx7LwUkYYiNH-SHg/viewform?usp=sharing)"
    )
